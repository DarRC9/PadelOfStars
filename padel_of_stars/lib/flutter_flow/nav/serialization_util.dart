    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case PadelClubsRow:
            return PadelClubsRow(data);
          case CategoriasRow:
            return CategoriasRow(data);
          case TorneosRow:
            return TorneosRow(data);
          case CategoriasTorneosRow:
            return CategoriasTorneosRow(data);
          case ParejasRow:
            return ParejasRow(data);
          case GruposRow:
            return GruposRow(data);
          case EstadosTorneoRow:
            return EstadosTorneoRow(data);
          case TablaGruposRow:
            return TablaGruposRow(data);
          case JugadoresRow:
