                ...
                children: [
                      ...
                      child: SizedBox(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Escribe el nombre del Torneo...',
                  ...
                  Align(
                    ...
                    child: FutureBuilder<List<PadelClubsRow>>(
                      future: PadelClubsTable().queryRows(
                        queryFn: (q) => q,
                      ),
                      builder: (context, snapshot) {
                        ...
                        List<PadelClubsRow> clubPadelClubsRowList =
                            snapshot.data!;
                        return FlutterFlowDropDown<String>(
                          controller: _model.clubValueController ??=
                              FormFieldController<String>(null),
                          options: clubPadelClubsRowList
                              .map((e) => e.nombre)
                              .withoutNulls
                              .toList(),
                          onChanged: (val) =>
                              setState(() => _model.clubValue = val),
                          height: 56.0,
                          textStyle:
                              FlutterFlowTheme.of(context).bodyMedium.override(
                                    fontFamily: 'Readex Pro',
                  ...
                  Align(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(8.0),
                      child: Image.network(
                        'https://worldpadeltour.com/assets/themes/worldpadeltour.com/img/dynamic_torneos_cartel_402/95ce2cd35c.PNG',
                        width: 300.0,
                        height: 354.0,
                        fit: BoxFit.cover,
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await TorneosTable().insert({
                          ...
                          'Estado': 1,
                          'Precio': int.tryParse(_model.precioController.text),
                          'idClub': 1,
